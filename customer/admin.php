...
if(isset($_POST['add_product'])){
   ...
   $insert_query = mysqli_query($con, "INSERT INTO Product(product_name, price, image,customer_ID) VALUES('$p_name', '$p_price', '$p_image','$customer_ID')") or die('query failed');
...
if(isset($_POST['update_product'])){
   ...
   $update_query = mysqli_query($con, "UPDATE Product SET product_name = '$update_p_name', price = '$update_p_price', image = '$update_p_image' WHERE product_ID = '$update_p_id'");
